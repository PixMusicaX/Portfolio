...
export const DevBackground = ({ position = "fixed" }: { position?: "fixed" | "absolute" }) => (
  <div className={`${position} inset-0 overflow-hidden pointer-events-none z-0`}>
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ y: [0, -100, 50, 0], x: [0, 80, -40, 0], rotate: [0, 45, -20, 0], opacity: [0, 0.08, 0] }} 
    ...
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ y: [0, 150, -50, 0], x: [0, -100, 60, 0], rotate: [0, -30, 15, 0], opacity: [0, 0.10, 0] }} 
    ...
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ y: [0, -80, 120, 0], x: [0, 50, -80, 0], opacity: [0, 0.07, 0] }} 
    ...
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ y: [0, -150, 80, 0], x: [0, -70, 90, 0], rotate: [0, 90, -45, 0], opacity: [0, 0.12, 0] }} 
    ...
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ x: [0, 120, -120, 0], y: [0, 80, -80, 0], opacity: [0, 0.08, 0] }} 
    ...
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ y: [0, -200, 100, 0], rotate: [0, -180, 180, 0], opacity: [0, 0.14, 0] }} 
...
export const MusicBackground = ({ position = "fixed" }: { position?: "fixed" | "absolute" }) => (
  <div className={`${position} inset-0 overflow-hidden pointer-events-none z-0`}>
    ...
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ y: [0, -120, 60, 0], x: [0, 100, -80, 0], scale: [1, 1.2, 0.8, 1], opacity: [0, 0.10, 0] }} 
      transition={{ repeat: Infinity, duration: 25, ease: "easeInOut" }} 
    ...
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ y: [0, 150, -100, 0], x: [0, -150, 80, 0], scale: [1, 0.8, 1.2, 1], opacity: [0, 0.09, 0] }} 
      transition={{ repeat: Infinity, duration: 30, ease: "easeInOut" }} 
    ...
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ y: [0, -150, 100, 0], x: [0, 80, -100, 0], rotate: [-12, -45, 15, -12], opacity: [0, 0.12, 0] }} 
      transition={{ repeat: Infinity, duration: 28, ease: "easeInOut" }} 
    ...
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ y: [0, 200, -150, 0], x: [0, -100, 120, 0], rotate: [-45, 45, -90, -45], opacity: [0, 0.11, 0] }} 
      transition={{ repeat: Infinity, duration: 35, ease: "easeInOut" }} 
    ...
    {/* Abstract Guitar Shape */}
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ y: [0, -100, 150, 0], x: [0, -60, 40, 0], rotate: [15, -15, 30, 15], opacity: [0, 0.10, 0] }} 
      transition={{ repeat: Infinity, duration: 32, ease: "easeInOut" }} 
      className="absolute top-1/3 right-10"
    >
      <svg viewBox="0 0 100 200" className="w-32 h-64 stroke-black/40 fill-none" strokeWidth="2">
        <path d="M50 180 C25 180 15 150 15 130 C15 115 35 110 35 100 C35 90 20 85 20 65 C20 45 35 35 50 35 C65 35 80 45 80 65 C80 85 65 90 65 100 C65 110 85 115 85 130 C85 150 75 180 50 180 Z" />
        <line x1="50" y1="35" x2="50" y2="5" />
        <rect x="42" y="0" width="16" height="10" rx="2" strokeWidth="1" />
...
export const FusionBackground = ({ position = "fixed" }: { position?: "fixed" | "absolute" }) => (
  <div className={`${position} inset-0 overflow-hidden pointer-events-none z-0`}>
    <motion.div initial={{ opacity: 0 }} animate={{ y: [0, -120, 60, 0], x: [0, 100, -80, 0], scale: [1, 1.2, 0.8, 1], opacity: [0, 0.10, 0] }} transition={{ repeat: Infinity, duration: 25, ease: "easeInOut" }} className="absolute -top-20 -right-20">
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ y: [0, 150, -100, 0], x: [0, -150, 80, 0], scale: [1, 0.8, 1.2, 1], opacity: [0, 0.09, 0] }} transition={{ repeat: Infinity, duration: 30, ease: "easeInOut" }} className="absolute bottom-0 -left-20">
