...
export default function ElectronicPage() {
  ...
  return (
    <div className="min-h-[100dvh] bg-zinc-50 text-zinc-900 font-[family-name:var(--font-outfit)] relative overflow-hidden flex">
      ...
      <main className="flex-1 flex flex-col items-center justify-between py-16 pl-16 relative z-20 overflow-y-auto">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-zinc-600/60 max-w-xl mx-auto italic font-light" style={{ fontFamily: "'Georgia', 'Times New Roman', serif" }}>
            Modern digital synthesis featuring deep sub-basses, crisp sonics, and immaculate sound design.
          </p>
        </motion.div>
      ...
      <motion.div
        ...
        className="absolute inset-0 bg-zinc-800 pointer-events-none z-[9999]"
      />
    </div>
  );
}