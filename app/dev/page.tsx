...
import { SiGithub, SiGmail, SiResearchgate } from "react-icons/si";
            ...
            <section className="min-h-screen w-full flex flex-col justify-center snap-start py-20 relative pb-32">
              <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.8 }}>
                ...
                <div className="flex items-center gap-6 mt-8">
                  ...
                  <a href="https://www.researchgate.net/profile/Pinaki-Singha-2" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-white transition-colors" title="ResearchGate">
                    <SiResearchgate size={22} />
                  </a>
                  <a href="https://www.albdo.dev" target="_blank" rel="noopener noreferrer" className="text-zinc-500 hover:text-white transition-colors" title="AlBDO">
